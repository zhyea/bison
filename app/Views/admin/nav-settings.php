<div class="container main">
    ...
    <form method="post" action="<?= $siteUrl ?>/admin/nav/maintain">
        ...
        <div class="row">
            <div class="btn-left col-md-6 col-xs-12">
                <a class="btn btn-info" href="<?= $siteUrl ?>/admin/nav/list/<?= $parent ?>">返回列表</a>
            </div>
...
<script charset="utf-8" src="<?= $uriAdmin ?>/js/bootstrap-treeview.js"></script>
<script>
    function renderTree() {
        $.ajax({
            type: 'post',
            contentType: "application/json",
            url: '<?=$siteUrl?>/admin/nav/candidates',
            async: true,
            timeout: 6 * 1000,
